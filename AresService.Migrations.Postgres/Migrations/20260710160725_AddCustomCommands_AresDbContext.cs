    ...
    public partial class AddCustomCommands_AresDbContext : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UniqueId = table.Column<Guid>(type: "uuid", nullable: false),
                    CommandTemplateId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()"),
                    LastModified = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()")
                },
                constraints: table =>
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(
                """
                UPDATE "CommandMetadata" AS metadata
                SET "CommandTemplateId" = commands."CommandTemplateId"
                FROM "DeviceCommands" AS commands
                WHERE commands."UniqueId" = metadata."DeviceCommandId";
                """);
