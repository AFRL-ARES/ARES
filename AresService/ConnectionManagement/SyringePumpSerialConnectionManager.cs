...
public class SyringePumpSerialConnectionManager : ISerialConnectionManager<ISyringePumpConnection>
{
  private readonly ISerialConnectionRepository _connectionRepository;

  public SyringePumpSerialConnectionManager(ISerialConnectionRepository connectionRepository)
  {
