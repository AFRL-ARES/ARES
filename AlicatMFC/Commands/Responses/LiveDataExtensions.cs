...
public static class LiveDataExtensions
{
  public static MfcLiveDataResponse ToProto(this LiveDataResponse internalResponse)
  {
    var response = new MfcLiveDataResponse
    {
      ...
      MassFlow = internalResponse.MassFlow is not null ? new UnitValue { Unit = StandardVolumeFlow.GetAbbreviation(StandardVolumeFlowUnit.StandardCubicCentimeterPerMinute), Value = internalResponse.MassFlow.Value.StandardCubicCentimetersPerMinute } : default,
      Setpoint = internalResponse.Setpoint is not null ? new UnitValue { Unit = StandardVolumeFlow.GetAbbreviation(StandardVolumeFlowUnit.StandardCubicCentimeterPerMinute), Value = internalResponse.Setpoint.Value.StandardCubicCentimetersPerMinute } : default,
