...
{
  public class TubeFurnaceConnectionManager : IConnectionManager<ITubeFurnaceConnection>
  {
    readonly IConnectionRepository _connectionRepository;
    public TubeFurnaceConnectionManager(IConnectionRepository connectionRepository)
    {
